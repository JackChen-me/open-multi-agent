 ...
 *
 * Run:
 *   npx tsx examples/basics/structured-input.ts ./photo.png
 *
 * Prerequisites:
...
import { OpenMultiAgent, type LLMMessage } from '../../packages/core/src/index.js'

const imagePath = process.argv[2]
if (!imagePath) {
  throw new Error('Pass an image path: npx tsx examples/basics/structured-input.ts ./photo.png')
}
