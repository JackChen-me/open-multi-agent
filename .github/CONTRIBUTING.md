...
CI is the source of truth for the full pre-merge matrix. It runs lint, unit tests on Node 22/24, coverage, workspace builds, package/import smoke tests, template type-checking, tarball assertions, and the scaffold E2E test.
